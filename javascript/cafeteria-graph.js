...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Grabs the graph
    const cafeteriaGraph = document.getElementById('cafeteria-graph');
    ...
    switch(d.getDay()) { // Gets day of the week, found this at https://www.w3schools.com/jsref/jsref_getday.asp
        case 0:
            // Sunday
            var hours = ["10 am", "11 am", "12 pm", "1 pm", "4 pm", "5 pm", "6 pm", "7 pm"];
            break;
        case 1:
            // Monday
            var hours = ["7 am", "8 am", "9 am", "10 am", "11 am", "12 pm", "1 pm", "2 pm", "3 pm", "4 pm", "5 pm", "6 pm", "7 pm"];
            break;
        case 2:
            // Tuesday
            var hours = ["7 am", "8 am", "9 am", "10 am", "11 am", "12 pm", "1 pm", "2 pm", "3 pm", "4 pm", "5 pm", "6 pm", "7 pm"];
        ...
        case 5:
            // Friday
            var hours = ["7 am", "8 am", "9 am", "10 am", "11 am", "12 pm", "1 pm", "2 pm", "3 pm", "4 pm", "5 pm", "6 pm"];
            break;
        case 6:
            // Satuday
            var hours = ["10 am", "11 am", "12 pm", "1 pm", "4 pm", "5 pm"];
            break;
    }
